...
var CommandWhitelist = map[string]CommandSpec{
	...
	// Common readonly commands needed for system inspection
	"which":      {ReadOnly: true},
	"whereis":    {ReadOnly: true},
	...
	"pwd":        {ReadOnly: true},
	"stat":       {ReadOnly: true, RequiresPathCheck: true},
	"file":       {ReadOnly: true, RequiresPathCheck: true},
	"readlink":   {ReadOnly: true},
	"realpath":   {ReadOnly: true},
	"basename":   {ReadOnly: true},
	"dirname":    {ReadOnly: true},
	"md5sum":     {ReadOnly: true},
	"sha256sum":  {ReadOnly: true},
	"awk":        {ReadOnly: true},
	"sed":        {ReadOnly: true},
	"tr":         {ReadOnly: true},
	"cut":        {ReadOnly: true},
	"uniq":       {ReadOnly: true},
	"tee":        {ReadOnly: false, RequiresPathCheck: true},
	"diff":       {ReadOnly: true},
	"comm":       {ReadOnly: true},
	"xargs":      {ReadOnly: true},
	"tac":        {ReadOnly: true},
	...
	"hexdump":    {ReadOnly: true},
	"od":         {ReadOnly: true},
	"mount":      {ReadOnly: true},
	"lsblk":      {ReadOnly: true},
	"blkid":      {ReadOnly: true},
	"fdisk":      {ReadOnly: true, ArgPrefixWhitelist: []string{"-l"}},
	"dmidecode":  {ReadOnly: true},
	"lscpu":      {ReadOnly: true},
	"lsmem":      {ReadOnly: true},
	"nproc":      {ReadOnly: true},
	"getconf":    {ReadOnly: true},
	"sysctl":     {ReadOnly: true, ArgPrefixWhitelist: []string{"-a", "-n"}},
	"vmstat":     {ReadOnly: true},
	"iostat":     {ReadOnly: true},
	"mpstat":     {ReadOnly: true},
	"sar":        {ReadOnly: true},
	"netstat":    {ReadOnly: true},
	"ifconfig":   {ReadOnly: true},
	"route":      {ReadOnly: true},
	"arp":        {ReadOnly: true},
	"dig":        {ReadOnly: true},
	"nslookup":   {ReadOnly: true},
	"ping":       {ReadOnly: true},
	"traceroute": {ReadOnly: true},
	"docker":     {ReadOnly: true, ArgPrefixWhitelist: []string{"ps", "images", "logs", "inspect", "stats", "top", "info", "version"}},
	"crictl":     {ReadOnly: true, ArgPrefixWhitelist: []string{"ps", "images", "logs", "inspect", "stats", "info", "version"}},
	"kubectl":    {ReadOnly: true, ArgPrefixWhitelist: []string{"get", "describe", "logs", "top", "version", "cluster-info"}},
	// Development tools (readonly inspection)
	"node":       {ReadOnly: true, ArgPrefixWhitelist: []string{"-v", "--version", "-e", "-p"}},
	"npm":        {ReadOnly: true, ArgPrefixWhitelist: []string{"-v", "--version", "list", "ls", "info", "view", "outdated", "audit"}},
	"python":     {ReadOnly: true, ArgPrefixWhitelist: []string{"--version", "-V", "-c"}},
	"python3":    {ReadOnly: true, ArgPrefixWhitelist: []string{"--version", "-V", "-c"}},
	"go":         {ReadOnly: true, ArgPrefixWhitelist: []string{"version", "env", "list", "doc"}},
	"java":       {ReadOnly: true, ArgPrefixWhitelist: []string{"-version", "--version"}},
	"git":        {ReadOnly: true, ArgPrefixWhitelist: []string{"status", "log", "diff", "branch", "show", "remote", "tag", "describe", "rev-parse", "ls-files"}},
}
